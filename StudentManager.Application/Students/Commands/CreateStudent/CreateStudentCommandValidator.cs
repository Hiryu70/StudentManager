...
namespace StudentManager.Application.Students.Commands.CreateStudent
{
	public class CreateStudentCommandValidator : AbstractValidator<CreateStudentCommand>
	{
		...
		public CreateStudentCommandValidator(IStudentManagerContext context)
		{
			_context = context;
		...
		private async Task<bool> UniqueNickname(CreateStudentCommand command, string nickname, CancellationToken cancellationToken)
		{
